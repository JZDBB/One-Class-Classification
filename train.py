...
flags.DEFINE_float("r_alpha", 0.000005, "Refinement parameter [0.00001]")
flags.DEFINE_float("r_beta", 0.00025, "VAE parameter [0.001]")
...
flags.DEFINE_string("log_dir", "log_step1", "Directory name to save the log [log]") # logs_pre
